  ...
  <div class="register">
    <section class="form_container">
      <div class="manage_tip">
        <span class="title">密黄杏资金管理系统</span>
        <el-form
          :model="registerUser"
          :rules="rules"
          ref="registerForm"
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" @click="registerForm('registerForm')" class="submit_btn">注册</el-button>
          </el-form-item>
        </el-form>
      </div>
    </section>
    ...
    return {
      ...
      rules:{
        name:[
          ...
          {min:2,max:30,message:'用户名在2-30个字符之间',trigger:'blur'}
        ],
        email:[
        ...
        password:[
          ...
          {min:6,max:30,message:'密码在6-30个字符之间',trigger:'blur'}
        ],
        password2:[
           {required:true,message:'密码不能为空',trigger:'blur'},
          {min:6,max:30,message:'密码在6-30个字符之间',trigger:'blur'},
